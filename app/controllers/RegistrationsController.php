...
class RegistrationsController extends \BaseController {
	...
	public function create()
	{
		...
		return View::make(
						...
						compact('classifications','locations','employees',
							'generations','majors','courses','charges',
	...
	public function store()
	{
		...
		try
		{
			...
			$education->major_id = Input::get('major');
			$education->save();
			...
			$content = 'Bergabung menjadi Siswa JILC '.Auth::user()->location->name.'untuk periode '.Auth::user()->curr_project->name;
