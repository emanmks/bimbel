                ...
                <div class="box-body table-responsive">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="data-table">
                        ...
                        @foreach($handbooks as $handbook)
                            <tr>
                                <td><strong>{{ $handbook->code }}</strong></td>
                                ...
                                <td>
                                    ...
                                    <input type="hidden" id="major-{{ $handbook->id }}" value="{{ $handbook->major_id }}">
                                    <input type="hidden" id="code-{{ $handbook->id }}" value="{{ $handbook->code }}">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label" for="major">Jurusan</label>
                        <div class="col-lg-5">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="modal">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label" for="updated_major">Jurusan</label>
                        <div class="col-lg-5">
                            <select class="form-control" name="updated_major">
                            	@foreach($majors as $major)
                            		<option value="{{ $major->id }}">{{ $major->name }}</option>
                            	@endforeach
                            </select>
...
<script type="text/javascript">
    ...
    function update()
    {
        ...
        var major = $('select[name=updated_major]').val();
