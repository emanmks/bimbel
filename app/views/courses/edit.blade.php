            ...
            <div class="box">
                ...
                <div class="box-body">
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 control-label" for="program">Program Bimbingan</label>
                            <div class="col-lg-3">
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 control-label" for="major">Kelompok Bidang Studi</label>
                            <div class="col-lg-3">
...
<script type="text/javascript">
    $(document).ready(function() {
    	...
    	$('select[name=major]').val("{{ $course->major_id }}");
