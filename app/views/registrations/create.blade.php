    ...
    <div class="wizard" id="registration-wizard" data-title="Pendaftaran Siswa">
        ...
        <div class="wizard-card" data-cardname="installment">
            ...
            <div class="wizard-input-section">
                ...
                <div class="form-group">
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="fee" value="100000">
                    </div>
                </div>
            </div>

            <div class="wizard-input-section">
              <p>Total Biaya Bimbingan</p>
              <div class="form-group">
                  <div class="col-sm-6">
            ...
            <div class="wizard-input-section">
              <p>Sisa Beban Biaya Bimbingan</p>
              <div class="form-group">
                  <div class="col-sm-6">
            ...
            <div class="wizard-input-section">
              <p>Pendapatan Bersih untuk Cabang</p>
              <div class="form-group">
                  <div class="col-sm-6">
