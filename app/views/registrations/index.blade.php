                            ...
                            <tr>
                                <td>
                                    <div class="pull-left image mytooltip">
                                        ...
                                        <a href="{{ URL::to('pendaftaran') }}/{{ $registration->id }}" data-toggle="tooltip" data-placement="right" title="Klik untuk lihat Rangkuman Pendaftaran">
                                            {{ $registration->issue->issue or '' }} /
                                            {{ $registration->issue->student->name or '' }}
                                        </a>
                                    </div>
                                ...
                                <td>
                                    @if($registration->classification->name == 'Siswa Pindahan')
                                        <span class="badge bg-yellow">{{ $registration->classification->name or '' }} dari {{ $registration->base->name or '' }}</span>
                                    @else
                                        <span class="badge bg-yellow">{{ $registration->classification->name or '' }}</span>
                                    @endif
                                </td>
                                <td>
                                ...
                                -->
                                <td>{{ $registration->employee->name or '' }}</td>
                                <td>
                                    <div class="mytooltip">
