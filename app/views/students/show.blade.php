            ...
            <div class="tab-content">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="list-group">
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-user"></i>   {{ $student->student->name or '' }}
                                ...
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-calendar"></i>   {{ $student->student->birthplace or '' }}, {{ date('d-m-Y', strtotime($student->student->birthdate)) }}
                                    <span class="pull-right text-muted small">Tempat, Tgl Lahir</span>
                                </a>
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-user"></i>   {{ $student->student->religion or '' }}
                                    <span class="pull-right text-muted small">Agama</span>
                                </a>
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-home"></i>   {{ $student->student->address or '' }}
                                    <span class="pull-right text-muted small">Alamat</span>
                                </a>
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-phone"></i>   {{ $student->student->contact or '' }}
                                    <span class="pull-right text-muted small">Kontak</span>
                                </a>
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-envelope"></i>   {{ $student->student->email or '' }}
                ...
                <div class="tab-pane fade" id="parent">
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="list-group">
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-user"></i>  {{ $student->student->father_name or '' }}
                                    <span class="pull-right text-muted small">Nama Ayah</span>
                                </a>
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-institution"></i> {{ $student->student->father_occupation or '' }}
                                    <span class="pull-right text-muted small">Pekerjaan Ayah</span>
                                </a>
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-home"></i>   {{ $student->student->father_address or '' }}
                                    <span class="pull-right text-muted small">Alamat Ayah</span>
                                </a>
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-phone"></i>   {{ $student->student->father_contact or '' }}
                                    <span class="pull-right text-muted small">Kontak Ayah</span>
                                </a>
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-envelope"></i>  {{ $student->student->father_email or '' }}
                        ...
                        <div class="col-xs-6">
                            <div class="list-group">
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-user"></i>   {{ $student->student->mother_name or '' }}
                                    <span class="pull-right text-muted small">Nama Ibu</span>
                                </a>
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-institution"></i> {{ $student->student->mother_occupation or '' }}
                                    <span class="pull-right text-muted small">Pekerjaan Ibu</span>
                                </a>
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-home"></i>   {{ $student->student->mother_address or '' }}
                                    <span class="pull-right text-muted small">Alamat Ibu</span>
                                </a>
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-phone"></i>   {{ $student->student->mother_contact or '' }}
                                    <span class="pull-right text-muted small">Kontak Ibu</span>
                                </a>
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-envelope"></i>   {{ $student->student->mother_email or '' }}
                        ...
                        <div class="col-xs-12">
                            <div class="list-group">
                                @foreach($student->educations as $education)
                                    <a href="#" class="list-group-item">
                                        <i class="fa fa-institution"></i>  {{ $education->school->name or '' }}
                ...
                <div class="tab-pane fade" id="course">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="mytooltip">
                                <a href="#" onclick="showFormUpdateIssue({{ $student->id }},{{ $student->issue }},{{ $student->generation_id }})" data-toggle="tooltip" data-placement="top" title="Klik Untuk Koreksi"><i class="fa fa-edit"></i></a>
                            </div>
                            <div class="list-group">
                                <a href="#" class="list-group-item">
                            ...
                            @foreach($student->placements as $placement)
                                ...
                                <div class="list-group">
                                    <a href="#" class="list-group-item">
                                        <i class="fa fa-institution"></i>   {{ $placement->course->name or '' }}
                                        <span class="pull-right text-muted small">Nama Kelas</span>
                                    </a>
                                    <a href="#" class="list-group-item">
                                        <i class="fa fa-calendar"></i> {{ $placement->course->course_days or '' }}
                                        <span class="pull-right text-muted small">Hari Belajar</span>
                                    </a>
                                    <a href="#" class="list-group-item">
                                        <i class="fa fa-database"></i>   {{ $placement->course->capacity or '' }}
                                    ...
                                    @foreach($student->points as $point)
                                        @if($point->pointable_type == 'Quiz')
                                            <tr>
                                                ...
                                                <td>{{ $point->pointable->subject->name or '' }}</td>
                                                <td>{{ $point->pointable->name or '' }}</td>
                                                <td>{{ $point->point }}</td>
                                            </tr>
                                        @endif
                                    @endforeach
                            ...
                            <table class="table table-condensed">
                                ...
                                <tbody>
                                    @foreach($student->masteries as $mastery)
                                        <tr>
                                            <td>{{ $mastery->subject->name or '' }}</td>
                                            <td>{{ $mastery->mastery or '' }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
...
<script type="text/javascript">
    ...
    function showFormUpdateIssue(id,issue, generation_id)
    {
        $('#formUpdateIssue').modal('show');

        $('[name=issue_id]').val(id);
        $('[name=issue]').val(issue);
        $('[name=generation_id]').val(generation_id);
    }
    ...
    function updateIssue()
    {
        ...
        var generation_id = $('[name=generation_id]').val();
        ...
        if(issue_id != '0' && new_issue != '')
        {
            $.ajax({
                ...
                type:"PUT",
                data:{issue:new_issue, generation_id:generation_id},
                success:function(){
